...
import { Snowflake, Wrench, ShieldCheck, Clock, MapPin, Award, Phone, CheckCircle2, Sparkles, Zap, Star, ThumbsUp, User } from "lucide-react";
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-8 md:py-20 lg:py-28">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <div className="text-white">
              ...
              <div className="inline-flex items-center gap-2 rounded-2xl px-4 py-2 mb-4 text-base md:text-lg font-extrabold shadow-lg" style={{ backgroundColor: "oklch(0.85 0.18 95)", color: "oklch(0.25 0.14 255)" }}>
                <CheckCircle2 className="h-5 w-5" />
                VISITA SIN COSTO en Lanús y alrededores
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] tracking-tight">
                Técnico de Heladeras<br/>
                <span style={{ background: "linear-gradient(90deg, oklch(0.92 0.06 225), oklch(0.78 0.13 230))", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
                  y Lavarropas en Zona Sur
                </span>
              </h1>
              <p className="mt-6 text-lg md:text-xl text-white/90 max-w-xl leading-relaxed">
                Reparamos heladeras familiares y comerciales, lavarropas, bateas, exhibidoras, cámaras de frío y cavas de vino en Zona Sur (Lanús, Lomas, Banfield, Avellaneda y alrededores). Servicio técnico profesional con garantía.
              </p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4">
                ...
                >
                  ...
                  Pedí tu visita sin cargo ahora
                </a>
                <a
                  href="#servicios"
